# @womorg/perferendis-unde-impedit
...
<a href="https://www.npmjs.com/package/@womorg/perferendis-unde-impedit">
  <img alt="npm version" src="https://img.shields.io/npm/v/@womorg/perferendis-unde-impedit.svg?style=flat-square" />
</a>
<a href="https://www.npmjs.com/package/@womorg/perferendis-unde-impedit">
  <img alt="npm downloads" src="https://img.shields.io/npm/dm/@womorg/perferendis-unde-impedit.svg?style=flat-square" />
</a>
...
```bash
# using npm
npm install -D @womorg/perferendis-unde-impedit
# using pnpm
pnpm install -D @womorg/perferendis-unde-impedit
# using yarn
yarn add --dev @womorg/perferendis-unde-impedit
```
...
```ts
import { svgSpritemap } from '@womorg/perferendis-unde-impedit';
